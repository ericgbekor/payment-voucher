    ...
    $("#add").click(function () {
        $.ajax({
            ...
            data: {
                ...
                'category': $('input[name=scategory]').val()
            },
            success: function (data) {
                if ((data.errors)) {
                    ...
                    $('.error').remove();
                    $('#data').append("<tr class='item" + data.id + "'><td>" + data.id + "</td><td>" + data.name + "</td><td>" + data.category + "</td><td><button class='edit-modal btn btn-info' data-id='" + data.id + "' data-name='" + data.name + "' data-category='" + data.category + "'><span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-name='" + data.name + "' data-category='" + data.category + "'><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
                }
            }
        });
        $('#name').val('');
